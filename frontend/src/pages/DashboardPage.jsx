    ...
    <div>
      ...
      <div className="space-y-6 p-4 lg:p-8">
        <section className="card-paper grid gap-6 p-6 xl:grid-cols-[1.35fr_0.95fr] xl:p-8">
          <div>
            ...
            <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-600">
              Batch dibuat dari dashboard admin, data tahapan dikirim ke Pinata sebagai JSON, lalu CID-nya dicatat ke blockchain Sepolia. Wallet juga bisa langsung dihubungkan dari kanan atas untuk kebutuhan verifikasi operator atau ekspansi fitur web3 berikutnya.
            </p>
            <div className="mt-6 grid gap-3 sm:grid-cols-3">
              ...
              <div className="surface-muted rounded-[24px] p-4">
                ...
                <p className="mt-3 text-sm font-semibold text-slate-900">CID ke Sepolia</p>
                <p className="mt-1 text-xs text-slate-500">Setiap event proses tetap punya jejak on-chain.</p>
              </div>
              <div className="surface-muted rounded-[24px] p-4">
        ...
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          ...
          <StatCard title="Selesai" value={stats.completed} hint="Batch yang sudah mencapai packing" tone="green" />
        ...
        <div className="grid gap-6 xl:grid-cols-[1.7fr_1fr]">
          ...
          <div className="card p-6">
            ...
            <div className="mt-5 space-y-4 text-sm text-slate-600">
              ...
              <div className="surface-muted rounded-[22px] p-4">
                4. Payload complete atau skip disimpan dulu ke IPFS lalu CID-nya dicatat ke blockchain Sepolia.
              </div>
            </div>
          </div>
        </div>
