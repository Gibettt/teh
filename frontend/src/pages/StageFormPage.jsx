  ...
  return (
    <div>
      <Topbar
        ...
        subtitle="Data tahap akan dibentuk menjadi JSON, disimpan ke Pinata, lalu CID-nya dicatat ke blockchain Sepolia."
      ...
      <div className="p-4 lg:p-8">
        <form className="card-paper mx-auto max-w-4xl p-6 lg:p-8" onSubmit={handleSubmit}>
          ...
          <div className="surface-muted mt-5 rounded-[26px] p-4 text-sm text-slate-600">
            Setelah disimpan, backend akan membentuk payload JSON tahap ini, mengirimkannya ke IPFS, lalu CID IPFS akan ditulis ke smart contract.
          </div>
